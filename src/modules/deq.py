...
def deq(params: dict, rng, x: jnp.ndarray, fun: Callable, max_iter: int, is_training: bool) -> jnp.ndarray:
    """
    ...
    def g(_params, _rng, _x): return fun(_params, _rng, _x) - _x

    # find equilibrium point
    z = rootfind(g, max_iter, params, rng, x)

    if is_training:
        # set up correct graph for chain rule (bk pass)
        z = fun(params, rng, z)
        z = rootfind_grad(g, max_iter, params, rng, z)
    return z